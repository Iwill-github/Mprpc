                    ...
                    google::protobuf::Closure *done)
{
    ...
    if( -1 == clientfd ){
        ...
        // LOG << "create socket error! errno:" << errno;
        char buf[512] = {0};
